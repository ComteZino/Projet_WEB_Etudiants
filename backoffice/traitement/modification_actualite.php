        ...
        <div id="divPrincipal" class="box-actu">
            <form method="post" action="modif_actualite.php">
                ...
                <?php
                    ...
                    echo '<p>Auteur</p>';
                    echo '<input name="auteur" type="auteur"  class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" value = "' . $ligne["auteur"] . '" disabled>';
                    
                    echo '<p>Date</p>';
                    echo '<input name="date" type="date" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input"   value = "' . $ligne["date"] . '" disabled>';
                    
                    echo '<p>Titre</p>';
                    echo '<input name="titre" type="titre" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" value = "' . $ligne["titre"] . '">';
